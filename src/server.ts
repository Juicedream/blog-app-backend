...
const corsOptions: CorsOptions = {
  origin(origin, callback) {
    if (
      ...
      //nReject requests from non-whitelisted origins
      callback(
 ...
 * 
 *  - Tries to connect to the database before initailizing the server.
 ...
 *  - When either signal is received, `handleServerShutdown` is executed to ensure proprt cleanup.
 */
